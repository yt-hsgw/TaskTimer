...
11. カレンダーで週/日/月を切り替え、空きセルをダブルクリックしてタスクを追加します。予定ブロック本体のドラッグで期間を保ったまま移動し、両端のハンドルで開始/終了を調整できます。矢印キーでも移動・調整できます。サブタスクには親タスク名が表示され、カレンダー項目を選択すると詳細で対象を編集できます。
