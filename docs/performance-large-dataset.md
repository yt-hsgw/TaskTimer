...
| --- | --- | --- | --- | --- | ---: | --- |
| 2026-07-19 | Darwin / headless Chrome | #138作業ブランチ | 50タスク / 200サブタスク / 4リスト | `npm run perf:ui -- --profile smoke --fail-on-warning` | 0 | カード本文D&D、前面オーバーレイ、移動先列強調、保存後移動を含む。D&D 313ms、全項目閾値内。 |
