...
- ドラッグ&ドロップ、列の追加/名称変更/並べ替え、列ごとの完了セクションはGitHub #126で進行状態と完了状態を分離して実装する。
...
stateDiagram-v2
  ...
  CalendarView --> CalendarTaskCreate: 空きセルをダブルクリック / Enter
...
- 期間表示と端のドラッグによるリサイズはGitHub #127で期間モデルと合わせて実装する。
